INSERT INTO tb_product (name, price, image_Uri, description) VALUES ('Super Secão Max', 88.9, 'https://raw.githubusercontent.com/flaviaschuenquer/fsdelivery/main/imagens/Tapete.jpg', 'Para cães de todas as idades, abas laterais com vedacão total, extra gel e emb. 30 unidades.');
INSERT INTO tb_product (name, price, image_Uri, description) VALUES ('Ração Golden filhote', 57.9, 'https://raw.githubusercontent.com/flaviaschuenquer/fsdelivery/main/imagens/racao.jpg', 'Indicada para cães filhotes, auxilia no equilíbrio intestinal, pacote 15kg.');
INSERT INTO tb_product (name, price, image_Uri, description) VALUES ('Brinquedo Pelúcia', 27.9, 'https://raw.githubusercontent.com/flaviaschuenquer/fsdelivery/main/imagens/pelucia.jpg', 'Indicado para cães, divertido e criativo, ajuda a combater o estresse.');
INSERT INTO tb_product (name, price, image_Uri, description) VALUES ('Cama PETZ', 179.9, 'https://raw.githubusercontent.com/flaviaschuenquer/fsdelivery/main/imagens/cama.jpg', 'Super macia, dupla face, firme e resistente e não absorve umidade.');
INSERT INTO tb_product (name, price, image_Uri, description) VALUES ('Moleton com capuz', 109.9, 'https://raw.githubusercontent.com/flaviaschuenquer/fsdelivery/main/imagens/moleton.jpg', 'Ideal para o inverno, vai deixar o seu cão aquecido e estiloso.');
INSERT INTO tb_product (name, price, image_Uri, description) VALUES ('Banho e Tosa', 145.9, 'https://raw.githubusercontent.com/flaviaschuenquer/fsdelivery/main/imagens/banho_tosa.jpg', 'Seu pet limpinho, banho com hidratação e corte com tesoura.');
INSERT INTO tb_product (name, price, image_Uri, description) VALUES ('Casa Plástica', 699.0, 'https://raw.githubusercontent.com/flaviaschuenquer/fsdelivery/main/imagens/casa.jpg', 'Pode ficar em área externa, fácil de limpar e montagem rápida.');
INSERT INTO tb_product (name, price, image_Uri, description) VALUES ('Anti pulgas/carrapatos', 281.9, 'https://raw.githubusercontent.com/flaviaschuenquer/fsdelivery/main/imagens/remedio.jpg', 'Elimina pulgas e carrapatos rapidamente e não sai com o banho.');
